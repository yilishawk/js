var rule = {
	...
	url:'/show/fyclassfyfilter.html',
     searchUrl: 'https://nkdyw.us/rss/baidu.index.xml?wd=**',
	filterable:1,//是否启用分类筛选,
	filter_url:'{{fl.cateId}}--{{fl.by}}------fypage---{{fl.year}}',
	filter: {
  ...
  tab_remove:'失效',
   class_url:'13&1&2&3',
      推荐: 'body&&.diy-center;.public-list-box.public-pic-b;a&&title;img&&data-src;.public-list-subtitle&&Text;a&&href',
