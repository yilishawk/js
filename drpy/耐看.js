var rule = {
  ...
  limit: 6,
   推荐: '.public-list-box.public-pic-b;a&&title;img&&data-src;.public-list-subtitle&&Text;a&&href',
    一级: '.public-list-box.public-pic-b;a&&title;img&&data-src;.public-list-subtitle&&Text;a&&href',
     二级: {
                "title": "h3&&Text;.slide-info-remarks:eq(2)&&Text",
                "img": ".detail-pic&&img&&data-src",
                "desc": ".slide-info.hide:eq(1)&&Text;.slide-info-remarks:eq(0)&&Text;.slide-info-remarks:eq(1)&&Text;.video-info-items:eq(3)&&Text;.slide-info.hide:eq(2)&&Text;.slide-info.hide:eq(3)&&Text",
