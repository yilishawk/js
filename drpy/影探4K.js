var rule = {
	...
	host: 'http://cmstv3823.lyyytv.cn/api.php/app/',
	...
	class_name:'电视剧4K&新电影4K&好莱坞4K&港台经典4k&少儿动画4K&国剧盛典4K&怀旧TVB&动漫4K&邵氏老电影4K&国产老电影4K&合拍经典4K&明星专辑4K&恐怖片精选4K&动漫&综艺&电影综合&电视剧综合',
	class_url:'21&20&47&48&50&46&53&58&5&44&51&45&52&4&3&1&2',
	play_parse:true,
	lazy:`js:
		let play_Url = '';
        if (/\\.m3u8|\\.mp4/.test(input)) {
			...
			play_Url = /bilibili/.test(input) ? 'https://jx.xmflv.com/?url=' : 'json:https://api.qljson.xyz/api/?key=b78d98f3fd0aa0b881d159c52fd7321d&url='; // type1的parse可加'json:'直接解析url (除了蜂蜜的'影视TV'，其它的壳皆可用)
			input = {
				jx: 0,
				url: input,
				playUrl: play_Url,
